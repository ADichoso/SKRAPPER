...
RECYCLABLE = ['PET Bottle', 'Bottle Cap', 'Rubber Band', 'Spoon', 'Fork', 'Plastic Cup', 'Yakult',
			'Tin Can', 'Plastic Lid', 'Cardboard', 'Doy Pack', 'Paper', 'Knife', 'Paper Bag', 'Box', 'Yellow Paper']
				...
				if not skip_scores:
					if not display_str:
						...
						if class_name in RECYCLABLE:
							display_str='{}: {}% [{}]'.format(display_str,int(100*scores[i]),'recyclable')
						else:
							display_str='{}: {}% [{}]'.format(display_str,int(100*scores[i]),'residual')
